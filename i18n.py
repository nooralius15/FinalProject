...
TRANSLATION_OVERRIDES_TR_EN: dict[str, str] = {
    ...
    "Orta": "Medium",
    "Yuksek": "High",
    "Bitirme Proje Takip | OSTİM Teknik Üniversitesi": "Final Project Tracking System | OSTIM Technical University",
    "🗂️ Bitirme Proje Takip Uygulaması": "🗂️ Final Project Tracking System",
    ...
    "Bu danismana ait grup/ogrenci kaydi yok.": "No group/student record for this advisor.",
    "Proje seçin": "Select project",
    "Lider adayı": "Leader candidate",
    "👑 Lideri Kaydet": "👑 Save Leader",
    "Lider guncellendi.": "Leader updated.",
    "CSV Yükle / Güncelle": "CSV Upload / Update",
    "CSV dosyası seçin": "Select CSV file",
    "öğrenci kaydı bulundu.": "student records found.",
    "✅ Öğrenci Listesini Güncelle": "✅ Update Student List",
    "➕ Yeni Öğrenci Ekle": "➕ Add New Student",
    "Öğrenci No": "Student No",
    "Ad Soyad": "Full Name",
    "Mevcut bir projeye ekle": "Add to existing project",
    "Mevcut proje seç": "Select existing project",
    "Yeni proje adı": "New project name",
    "✅ Öğrenciyi Ekle": "✅ Add Student",
    ...
    "Detay görüntülenecek proje": "Project to view in detail",
    "Geri bildirim yazın": "Write feedback",
    "Aksiyon maddesi": "Action item",
    "Revizyon gerekli": "Revision required",
    "Geri bildirim bos olamaz.": "Feedback cannot be empty.",
    "Geri bildirim kaydedildi.": "Feedback saved.",
    "Öğrenci ara": "Search student",
    "Birden fazla sonuç bulundu, seçin": "Multiple results found, select",
    "Ogrenci kaydi bulunamadi.": "Student record not found.",
    "Atanan Görev": "Assigned Tasks",
    "İlerleme": "Progress",
    # ── Leader panel ──────────────────────────────────────────────────────────
    "Yapay zeka grubunuzun durumunu analiz ediyor": "AI analyzes your group status",
    "✨ Grubumu Analiz Et": "✨ Analyze My Group",
    "Ollama (Gemini Flash) görev verilerinizi ve ilerlemenizi analiz eder.": "Ollama (Gemini Flash) analyzes your task data and progress.",
    "🤖 AI grubunuzu analiz ediyor...": "🤖 AI is analyzing your group...",
    "Grubunuzda şifre sıfırlanabilecek başka üye bulunmuyor.": "No other members whose password can be reset.",
    "Bu öğrenci grubunuzda kayıtlı değil.": "This student is not registered in your group.",
    "şifresi sıfırlandı.": "password was reset.",
    "Sıfırlama başarısız.": "Reset failed.",
    # ── Student panel ─────────────────────────────────────────────────────────
    "Durum güncelle": "Update status",
    "💡 Önceki milestone tamamlanmadan sonraki milestone görevine geçilemez.": "💡 You cannot move to the next milestone task before completing the previous one.",
    "Karşılaştırma kapsamı": "Comparison scope",
    "Danışman grupları": "Advisor groups",
    "Tüm gruplar": "All groups",
    "tamamlandı": "completed",
    "AI Kişisel Koç": "AI Personal Coach",
    "Yapay zeka çalışmanı analiz eder ve sana özel tavsiyeler verir": "AI analyzes your work and gives personalized advice",
    "✨ Çalışmamı Analiz Et": "✨ Analyze My Work",
    "Ollama (Gemini Flash) görevlerini, raporlarını ve danışman geri bildirimlerini analiz eder.": "Ollama (Gemini Flash) analyzes your tasks, reports, and advisor feedback.",
    "🤖 AI seni analiz ediyor...": "🤖 AI is analyzing you...",
    "AI Proje Analizi": "AI Project Analysis",
    "Yapay zeka destekli özet ve risk değerlendirmesi": "AI-powered summary and risk assessment",
    "✨ Tüm Projeleri Analiz Et": "✨ Analyze All Projects",
    "Ollama (Gemini Flash) tüm proje verilerini analiz eder ve danışmana özel bir rapor üretir.": "Ollama (Gemini Flash) analyzes all project data and produces a report for the advisor.",
    "🤖 AI analiz yapıyor...": "🤖 AI is analyzing...",
    "AI Grup Analizi": "AI Group Analysis",
    "⚠️ Ollama çalışmıyor. Lütfen terminal'de `ollama serve` komutunu çalıştırın.": "⚠️ Ollama is not running. Please run `ollama serve` in the terminal.",
    # ── Components ────────────────────────────────────────────────────────────
    "Yorum yaz": "Write comment",
    "Yorum ekle": "Add comment",
    "Yorum bos olamaz.": "Comment cannot be empty.",
    "Yorum eklendi.": "Comment added.",
    "Dosya bulunamadi": "File not found",
    "PDF dosyasi": "PDF file",
    "PDF indir": "Download PDF",
    "Dosya": "File",
    "Dosyayi indir": "Download file",
    # ── Security ──────────────────────────────────────────────────────────────
    "Oturum süresi doldu. Lütfen tekrar giriş yapın.": "Session expired. Please log in again.",
    "Çok fazla başarısız giriş denemesi.": "Too many failed login attempts.",
    "dakika sonra tekrar deneyin.": "minutes, then try again.",
    # ── Misc ──────────────────────────────────────────────────────────────────
    "Haftalık Güncellemeler": "Weekly Updates",
    "Projeye Verilen Geri Bildirimler": "Project Feedback",
    "Haftalık Giriş Geçmişi": "Weekly Entry History",
    "Görev Durumu (Milestone Bazlı)": "Task Status (By Milestone)",
    "Seçilen kullanıcının şifresi": "The selected user's password",
    "Sifresi sıfırlanacak üye": "Member to reset",
    "üye": "members",
    "geciken": "overdue",
    # ── Milestone labels ──────────────────────────────────────────────────────
    "Literatur taramasi": "Literature Review",
    "Algoritma ve uygulama plani": "Algorithm & Implementation Plan",
    "Uygulamayi boot etme": "Application Bootstrap",
    "Uygulamayi deneme ve sonuclari degerlendirme": "Testing & Evaluation",
    "Hatalari duzeltme ve tekrar deneme": "Bug Fixes & Retesting",
    "Proje yazimi ve final rapor": "Report Writing & Final Report",
    # ── Metric card labels ────────────────────────────────────────────────────
    ...
    "Güncelle": "Update",
    "Kanit linki": "Evidence link",
    "Kanit dosyasi yukle (resim, PDF vb.)": "Upload evidence file (image, PDF, etc.)",
    "Görev Yorumları": "Task Comments",
    "Üye Şifre Sıfırlama": "Member Password Reset",
    "Şifreyi unutan takım arkadaşınızın şifresini sıfırlayın": "Reset the password of a teammate who forgot it",
    "Üye seçin": "Select member",
    "Bu üyenin şifresinin sıfırlanacağını onaylıyorum": "I confirm this member's password will be reset",
    "🔑 Şifreyi Sıfırla": "🔑 Reset Password",
    "Haftalık İlerleme Girişi": "Weekly Progress Entry",
    "Bu haftaki çalışmalarınızı kaydedin": "Log this week's work",
    "Yapılanlar": "Completed",
    "Engeller": "Blockers",
    "Sonraki Adım": "Next Step",
    "Kanıt linki": "Evidence link",
    "📅 Haftalık Girişi Kaydet": "📅 Save Weekly Entry",
    "Danışman Geri Bildirimleri": "Advisor Feedback",
    # ── Student panel extra ───────────────────────────────────────────────────
    "Aktif Görev": "Active Task",
    "Tüm milestone görevlerini tamamladınız!": "You completed all milestone tasks!",
    "Grup Sıralaması": "Group Ranking",
    "Proje Genel Bakışı": "Project Overview",
    "Proje Özeti": "Project Summary",
    "Tüm projelerin tamamlanma, gecikme ve risk durumu": "Completion, delay and risk status of all projects",
    "Öğrenci Arama": "Student Search",
    "Ad veya numara ile arayın": "Search by name or number",
    "Proje Lideri Atama": "Assign Project Leader",
    "CSV Yükleme": "CSV Upload",
    "Öğrenci listesini CSV dosyasıyla güncelleyin": "Update student list with CSV file",
    "Tek Öğrenci Ekleme": "Add Single Student",
    "Şifre Sıfırlama": "Password Reset",
    "Proje Detayı & Görev Yönetimi": "Project Details & Task Management",
    "Milestone İlerlemesi": "Milestone Progress",
    "Gorev": "Tasks",
    # ── Advisor panel sections ────────────────────────────────────────────────
    "Görev Durumu (Milestone Bazlı):": "Task Status (By Milestone):",
    # ── Remaining strings ─────────────────────────────────────────────────────
    "Lider": "Leader",
    "Öğrenci": "Student",
...
SEGMENT_TRANSLATIONS_TR_EN: list[tuple[str, str]] = [
    ("Bitirme Proje Takip Uygulamasi", "Final Project Tracking System"),
    ("Bitirme Proje Takip Uygulaması", "Final Project Tracking System"),
    ("Bitirme Proje Takip Sistemi", "Final Project Tracking System"),
...
def render_language_selector() -> None:
    ...
    if selected_lang != current_lang:
        ...
        st.session_state["_needs_lang_cookie"] = True
        st.rerun()
